                            ...
                            <div className="col-xxl-6 col-xl-6 col-lg-6">
                                ...
                                <div className="form__group field my-3">
                                    ...
                                    >
                                        ...
                                        <option value="Guardamotores">Guardamotores</option>
                                        <option value="Interruptores de Potencia">Interruptores de Potencia</option>
                                        <option value="Reles de sobrecarga">Reles de sobrecarga</option>
                                    </select>
